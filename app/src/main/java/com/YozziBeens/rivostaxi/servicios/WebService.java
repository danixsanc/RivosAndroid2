...
public class WebService {
    ...
    // ya no se usaran
    public static final String CodeWebService = "http://appm.rivosservices.com/webservices/Code.php";
    public static final String GetPriceAirportToColonyWebService = "http://appm.rivosservices.com/webservices/GetPriceAirportToColony.php";
    public static final String GetPriceColonyToAirportWebService = "http://appm.rivosservices.com/webservices/GetPriceColonyToAirport.php";
    public static final String GetPriceColonyToColonyWebService = "http://appm.rivosservices.com/webservices/GetPriceColonyToColony.php";
    public static final String GetIfIsAirportWebService = "http://appm.rivosservices.com/webservices/GetIfIsAirport.php";
    ...
    //no se si se usaran
    public static final String GetUserWebService = "http://appm.rivosservices.com/webservices/GetUser.php";
    public static final String UpdateFavoritePlaceWebService = "http://appm.rivosservices.com/webservices/UpdateFavoritePlace.php";
    public static final String VerifyPasswordWebService = "http://appm.rivosservices.com/webservices/VerifyPassword.php";
    public static final String VerifyDestinationWebService = "http://appm.rivosservices.com/webservices/VerifyDestination.php";
    public static final String ModifyDataWebService = "http://appm.rivosservices.com/webservices/ModifyData.php";
    public static final String GetClientHistoryDetailsWebService = "http://appm.rivosservices.com/webservices/GetClientHistoryDetails.php";
    public static final String GetPlaceHistoryWebService = "http://appm.rivosservices.com/webservices/GetPlaceHistory.php";
    public static final String GetRequestForIdWebService = "http://appm.rivosservices.com/webservices/GetRequestForId.php";
